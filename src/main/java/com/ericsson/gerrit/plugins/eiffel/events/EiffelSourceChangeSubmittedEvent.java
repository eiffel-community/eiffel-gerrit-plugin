...
/**
 * This Eiffel Event model represents the EiffelSourceChangeSubmittedEvent and is populated with
...
public class EiffelSourceChangeSubmittedEvent {
    ...
    @Expose
    public EiffelSourceChangeSubmittedEventEventParams eventParams;
}
